...
public class AdminSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adminName = sharedPref.getString("name", "Admin");
        ...
        findViewById(R.id.itemNotifications).setOnClickListener(v -> {
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("Inbound requests notifications and system sounds are enabled by default.")
                    .setPositiveButton("OK", null)
                    .show();
        });
    ...
    private void showEditProfileBottomSheet() {
        ...
        etEditProfileName.setText(adminName);
        chosenImageUri = null;
        ...
        SharedPreferences sharedPref = getSharedPreferences("UserSession", Context.MODE_PRIVATE);
        File file = new File(getFilesDir(), "admin_profile_picture.jpg");
        if (file.exists()) {
        ...
        if (user != null) {
            ...
            db.collection("Users").document(user.getUid())
                    ...
                    .addOnSuccessListener(aVoid -> {
                        Toast.makeText(AdminSettingsActivity.this, "Profile updated successfully", Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    })
                    .addOnFailureListener(e -> {
                        Toast.makeText(AdminSettingsActivity.this, "Failed to sync: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    });
        } else {
            dialog.dismiss();
